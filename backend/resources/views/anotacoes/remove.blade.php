...
<div class="container mt-4">
    <h2 class="text-danger">⚠️ Confirmar Exclusão</h2>

    <p>Você tem certeza que deseja excluir a anotação abaixo?</p>

    <div class="card mb-3">
        <div class="card-body">
            <h5>{{ $anotacao->titulo }}</h5>
            <p>{{ $anotacao->texto }}</p>
            <small>Autor: {{ $anotacao->usuario->nome ?? 'Desconhecido' }}</small>
        </div>
    </div>
